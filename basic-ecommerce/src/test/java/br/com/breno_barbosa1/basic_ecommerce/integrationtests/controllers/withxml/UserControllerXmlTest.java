...
class UserControllerXmlTest extends AbstractIntegrationTest {
    ...
    void create() throws IOException {
        ...
        assertEquals("bruno@gmail.com", createdUser2.getEmail());
        assertEquals("San Francisco - USA", createdUser2.getAddress());
    }
    ...
    void findAll() throws JsonProcessingException {
        ...
        assertTrue(foundUsers.stream().anyMatch(user ->
            user.getEmail().equals("bruno@gmail.com") &&
            user.getAddress().equals("San Francisco - USA")
        ), "could not find any match for bruno@gmail.com");
    }
    ...
    public void mockUser() {
        ...
        user2.setEmail("bruno@gmail.com");
        user2.setAddress("San Francisco - USA");
    }
}