...
public class OrderItemRepositoryTest extends AbstractIntegrationTest {
    ...
    public void createOrderItem() {
        ...
        assertEquals(savedOrderItem.getId(), orderItem.getId());
        assertEquals(savedOrderItem.getProduct().getId(), order.getItems().getFirst().getProduct().getId());
        assertEquals(savedOrderItem.getOrder().getId(), order.getId());
        assertEquals(savedOrderItem.getOrder().getUser().getEmail(), user.getEmail());
        assertEquals(savedOrderItem.getQuantity(), order.getItems().getFirst().getQuantity());
        assertEquals(savedOrderItem.getPriceAtPurchase(), order.getItems().getFirst().getPriceAtPurchase());
    }
}